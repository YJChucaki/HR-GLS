...
using ApproxOperator.Elasticity: ∫∫vᵢbᵢdxdy, ∫vᵢtᵢds, L₂, L₂𝑝, Hₑ_PlaneStress, Hₑ_PlaneStrain_Deviatoric,∫∫σᵢⱼσₖₗdxdy_PlaneStrian,∫∫σᵢⱼσₖₗdxdy,∫σᵢⱼnⱼuᵢds,∫∫∇σᵢⱼuᵢdxdy,∫σᵢⱼnⱼgᵢds,∫∫τ∇σᵢⱼ∇σᵢₖdxdy,∫∫τ∇σᵢⱼ∇σᵢₖdxdy_new,∫∫τ∇σᵢⱼ∇σᵢₖdxdy_Taylor,∫∫σᵢⱼσₖₗdxdy_Taylor, Hₑ_PlaneStrain_Dil, 𝐿₂_PlaneStrain_Pressure, Hₑ_PlaneStrain_Deviatoric,∫∫σᵛᵢⱼσᵛₖₗdxdy,∫∫σᵈᵢⱼσᵈₖₗdxdy
using ApproxOperator.Elasticity:∫∫C∇εᵢⱼuᵢdxdy,∫∫Cᵈ∇εᵢⱼuᵢdxdy,∫∫Cᵛ∇εᵢⱼuᵢdxdy, ∫Cεᵢⱼnⱼuᵢds, ∫Cᵈεᵢⱼnⱼuᵢds, ∫Cᵛεᵢⱼnⱼuᵢds, ∫Cεᵢⱼnⱼgᵢds,  ∫Cᵈεᵢⱼnⱼgᵢds,  ∫Cᵛεᵢⱼnⱼgᵢds,∫∫εᵢⱼCᵢⱼₖₗεₖₗdxdy, ∫∫εᵈᵢⱼCᵢⱼₖₗεᵈₖₗdxdy, ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy, ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy_Taylor
...
prescribe!(elements["Ωˢᵛ"],:Ē=>(x,y,z)->Ē)
prescribe!(elements["Ωˢᵛ"],:ν̄ =>(x,y,z)->ν̄ )
...
prescribe!(elements["Γᵍᵘ"],:Ē=>(x,y,z)->Ē)
prescribe!(elements["Γᵍᵘ"],:ν̄ =>(x,y,z)->ν̄ )
prescribe!(elements["Γᵍᵘ"],:E=>(x,y,z)->E)
prescribe!(elements["Γᵍᵘ"],:ν =>(x,y,z)->ν )
...
prescribe!(elements["∂Ωᵘ"],:Ē=>(x,y,z)->Ē)
prescribe!(elements["∂Ωᵘ"],:ν̄ =>(x,y,z)->ν̄ )
...
𝑎 = ∫∫εᵢⱼCᵢⱼₖₗεₖₗdxdy=>elements["Ωˢ"]
ad = ∫∫εᵈᵢⱼCᵢⱼₖₗεᵈₖₗdxdy=>elements["Ωˢ"]
av = ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy=>elements["Ωˢᵛ"]
# 𝑎 =∫∫σᵢⱼσₖₗdxdy_Taylor=>elements["Ωˢ"]
𝑏 = [
    # ∫Cεᵢⱼnⱼuᵢds=>(elements["∂Ωˢ"],elements["∂Ωᵘ"]),
    # ∫∫C∇εᵢⱼuᵢdxdy=>(elements["Ωˢ"],elements["Ωᵘ"]),
    ∫Cᵛεᵢⱼnⱼuᵢds=>(elements["∂Ωˢᵛ"],elements["∂Ωᵘ"]),
    ∫∫Cᵛ∇εᵢⱼuᵢdxdy=>(elements["Ωˢᵛ"],elements["Ωᵘ"]),
    ∫Cᵈεᵢⱼnⱼuᵢds=>(elements["∂Ωˢ"],elements["∂Ωᵘ"]),
    ∫∫Cᵈ∇εᵢⱼuᵢdxdy=>(elements["Ωˢ"],elements["Ωᵘ"]),
   
    ]

𝑏ᵅ = [
    # ∫Cεᵢⱼnⱼgᵢds=>(elements["Γᵍˢ"],elements["Γᵍᵘ"]),
    ∫Cᵛεᵢⱼnⱼgᵢds=>(elements["Γᵍˢᵛ"],elements["Γᵍᵘ"]),
    ∫Cᵈεᵢⱼnⱼgᵢds=>(elements["Γᵍˢ"],elements["Γᵍᵘ"]),
     ]
