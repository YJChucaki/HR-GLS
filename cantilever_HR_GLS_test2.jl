...
using ApproxOperator.Elasticity: ∫∫C∇εᵢⱼuᵢdxdy, ∫Cεᵢⱼnⱼuᵢds, ∫Cεᵢⱼnⱼgᵢds,∫∫εᵢⱼCᵢⱼₖₗεₖₗdxdy, ∫∫εᵈᵢⱼCᵢⱼₖₗεᵈₖₗdxdy, ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy, ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy_Taylor, ∫∫εᵢⱼCᵢⱼₖₗEₖₗdxdy
...
prescribe!(elements["Ωˢᵛ"],:E=>(x,y,z)->E)
prescribe!(elements["Ωˢᵛ"],:ν=>(x,y,z)->ν)
...
𝑎b = ∫∫εᵢⱼCᵢⱼₖₗεₖₗdxdy=>elements["Ωˢ"]
𝑎v = ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy=>elements["Ωˢ"]
𝑎vv = ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy=>elements["Ωˢᵛ"]
𝑎vT = ∫∫εᵛᵢⱼCᵢⱼₖₗεᵛₖₗdxdy_Taylor=>elements["Ωˢ"]
𝑎d =∫∫εᵈᵢⱼCᵢⱼₖₗεᵈₖₗdxdy=>elements["Ωˢ"]
...
𝑏E = ∫∫εᵢⱼCᵢⱼₖₗEₖₗdxdy=>(elements["Ωˢ"],elements["Ωᵘ"])
𝑏ᵅ = ∫Cεᵢⱼnⱼgᵢds=>(elements["Γᵍˢ"],elements["Γᵍᵘ"])
