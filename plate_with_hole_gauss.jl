...
using ApproxOperator.Elasticity: ∫∫εᵢⱼσᵢⱼdxdy, ∫σᵢⱼnⱼgᵢds, ∫∫vᵢbᵢdxdy, ∫vᵢtᵢds, L₂, Hₑ_PlaneStress,  ∫vᵢgᵢds, ∫∫εᵢⱼσᵢⱼdxdy_PlaneStrian
using  Printf
include("import_plate_with_hole.jl")
include("wirteVTK.jl")
ndiv = 2
elements, nodes, Ω = import_plate_with_hole_gauss("msh/PlateWithHole_"*string(ndiv)*".msh",2*ndiv,0.8);
# ps = MKLPardisoSolver()
